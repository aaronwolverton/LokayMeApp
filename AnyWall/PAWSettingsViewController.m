...
{
	PAWWallViewController *wallDetailViewController = [[PAWWallViewController alloc] initWithNibName:@"PAWWallViewController" bundle:nil];
	wallDetailViewController.modalTransitionStyle = UIModalTransitionStyleCoverVertical;
	

    [self.navigationController presentViewController:wallDetailViewController animated:YES completion:nil];
